                ...
                <ul>
                    ...
                    <li className={style.item}>
                        ...
                        <div className={style.hover_on}>
                            ...
                            <div className={style.txt_box}>
                                <p>
                                    맞춤형 액상 개발부터 OEM·ODM까지. <br />
                                    전자담배 액상 전문 제조기업
                                </p>
                                <h5>PUFFU CHEMICAL</h5>
                            </div>
                        </div>
                        <div className={style.hover_off}>
                            <h5>PUFFU CHEMICAL</h5>
